        ...
        <div id="item01" className="port">
          <a href="#item01" className="close text-slate-800"></a>
            <div className="description w-full">
              <h1 className="text-slate-700 w-1/3 sm:w-3/3 text-2xl">Quire.work</h1>
              <p className="text-slate-700 w-1/3 sm:w-3/3 text-sm overflow-y-auto">Quire is a platform where users can create their own autonomous AI agents to automate and perform any type of work. Quire agents can work together in a collaborative manner to achieve common goals. This was built in Next / React, TypeScript, LangChain, and LlamaIndex, and uses both open-source LLMs like Mistral and GPT-3.5 / GPT-4.</p>
              <br></br>
