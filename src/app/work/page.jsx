        ...
        <a href="#item01" className="close text-slate-800"></a>
          <div className="row">
            <div className="description">
              <h1 className="text-slate-700 w-1/3">Quire.work</h1>
              <p className="text-slate-700 w-2/3 text-sm overflow-y-auto">Quire is a platform where users can create their own autonomous AI agents to automate and perform any type of work. Quire agents can work together in a collaborative manner to achieve common goals. This was built in Next / React, TypeScript, LangChain, and LlamaIndex, and uses both open-source LLMs like Mistral and GPT-3.5 / GPT-4.</p>
              <br></br>
              <a className="w-2/3 text-blue-400 hover:text-slate-400" href="https://quire.work" target="_blank">https://quire.work</a>
            </div>

            <img src="https://jddunn.github.io/assets/projects/quire-summarizer-optimized.gif" alt="Quire.work"/>
            </div>
          </div>
