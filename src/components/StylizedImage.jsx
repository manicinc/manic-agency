          ...
          <g className="origin-center scale-100 transition duration-500 motion-safe:group-hover:scale-105">
            <foreignObject width={width} height={height}>
              ...
              <svg className="Playground__svg ml-20" viewBox="0 0 100 120">
                  <image x="0%" y="0%" height="120" id="my-image" className="image-distorion base" id="base" preserveAspectRatio="xMidYMid slice" xlinkHref="https://images.unsplash.com/photo-1571977144562-3737f035296a?ixlib=rb-1.2.1&q=85&fm=jpg&crop=entropy&cs=srgb&ixid=eyJhcHBfaWQiOjE0NTg5fQ" ></image>
                  <image x="0%" y="0%" height="120" id="my-image" className="image-distorion red" id="red" preserveAspectRatio="xMidYMid slice" xlinkHref="https://images.unsplash.com/photo-1571977144562-3737f035296a?ixlib=rb-1.2.1&q=85&fm=jpg&crop=entropy&cs=srgb&ixid=eyJhcHBfaWQiOjE0NTg5fQ" ></image>
                  <image x="0%" y="0%" height="120" id="my-image" className="image-distorion cyan" id="cyan" preserveAspectRatio="xMidYMid slice" xlinkHref="https://images.unsplash.com/photo-1571977144562-3737f035296a?ixlib=rb-1.2.1&q=85&fm=jpg&crop=entropy&cs=srgb&ixid=eyJhcHBfaWQiOjE0NTg5fQ" ></image>
              </svg>
              )}
              {/* If not isSafari */}
              {!is_safari && (
