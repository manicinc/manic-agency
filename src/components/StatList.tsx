...
export const StatList: React.FC<React.HTMLAttributes<HTMLDivElement>> = ({ children, ...props }) => {
  return (
    <FadeInStagger {...props}>
...
export const StatListItem: React.FC<{ label: string; value: string }> = ({ label, value }) => {
  return (
